/* ═══════════════════════════════════════════════════════════════
   LATENT DIALOGIC SPACE — Claude API Integration
...
COMPANION.API = (function () {
  ...
  var STORAGE_KEY_API = 'latent_dialogic_v1_api_key';
  var STORAGE_KEY_MODEL = 'latent_dialogic_v1_model';
  var MAX_TOKENS = 4096;

  var STORAGE_KEY_SESSION_COUNT = 'latent_dialogic_v1_session_count';
  var STORAGE_KEY_SESSION_DATE = 'latent_dialogic_v1_session_date';
  var STORAGE_KEY_MSG_COUNT = 'latent_dialogic_v1_msg_count';
  var STORAGE_KEY_SESSION_START = 'latent_dialogic_v1_session_start';
  ...
  // -- Session Persistence --
  var SESSION_STORAGE_KEY = 'companion_dialogic_session';
  var SESSION_EXPIRY_MS = 30 * 60 * 1000;
