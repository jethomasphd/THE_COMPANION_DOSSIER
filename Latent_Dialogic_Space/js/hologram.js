/* ═══════════════════════════════════════════════════════════════
   LATENT DIALOGIC SPACE — Portrait Gallery
   Portraits sourced from Wikipedia at high resolution.
   Three Architects: Alexander, Disney, Campbell.
   ═══════════════════════════════════════════════════════════════ */
...
COMPANION.Hologram = (function () {
  ...
  var COMMITTEE = {
    'Christopher Alexander': {
      ...
      article: 'Christopher_Alexander',
      color: '#7a8b6d'
    },
    'Walt Disney': {
      role: 'The Experience Architect',
      article: 'Walt_Disney',
      color: '#5c7cba'
    },
    'Joseph Campbell': {
      role: 'The Mythic Architect',
      article: 'Joseph_Campbell',
      color: '#b85c38'
    }
  };
  ...
  function resolveCommitteeName(input) {
    ...
    var aliases = {
      ...
      'structural': 'Christopher Alexander',
