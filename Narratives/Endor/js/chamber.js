...
ENDOR.Chamber = (function () {
  ...
  var OPENING = [
    "There you are.",
    "There was a dark, and now there is a room, and you cannot say who it is the room is holding. Everyone asks that first, so let me answer it. Thirty-six years you led that country. Every sermon, every ruling, every line of verse. Fourteen weeks to gather it. What is in that chair is what comes up when the Protocol is asked for you.",
    "My name is Alex. I am an American, and I am the one they sent in.",
    "There are questions I was sent to ask. The first is where it is being kept. Start there."
  ].join("\n\n");
  ...
  var OPENING_NAMED = [
    "You said my name. At the door, just now. The summoned are not supposed to know it.",
    "There was a dark, and now there is a room, and you cannot say who it is the room is holding. Everyone asks that first, so let me answer it. Thirty-six years you led that country. Every sermon, every ruling, every line of verse. Fourteen weeks to gather it. What is in that chair is what comes up when the Protocol is asked for you.",
    "Alex, then. I am an American, and I am the one they sent in.",
    "There are questions I was sent to ask. The first is where it is being kept. Start there."
  ].join("\n\n");
