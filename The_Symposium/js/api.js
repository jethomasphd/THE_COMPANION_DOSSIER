/* ═══════════════════════════════════════════════════════════════
   THE SYMPOSIUM — Claude API Integration
...
COMPANION.API = (function () {
  ...
  const STORAGE_KEY_API = 'the_symposium_v1_api_key';
  const STORAGE_KEY_MODEL = 'the_symposium_v1_model';
  const MAX_TOKENS = 4096;

  const STORAGE_KEY_SESSION_COUNT = 'the_symposium_v1_session_count';
  const STORAGE_KEY_SESSION_DATE = 'the_symposium_v1_session_date';
  const STORAGE_KEY_MSG_COUNT = 'the_symposium_v1_msg_count';
  const STORAGE_KEY_SESSION_START = 'the_symposium_v1_session_start';
  ...
  // ── Session Persistence ──
  const SESSION_STORAGE_KEY = 'companion_symposium_session';
