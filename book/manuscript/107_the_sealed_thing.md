...
Contents pending. It was the one line in fourteen boxes of inventory that she had written in the passive and left in the passive. The receipt was in box 2 with the household papers, and she had cataloged it without comment in her first week: purchased the same month as the founding session, delivered to this address in the same week the dead first spoke in the study, plugged in, by the meter's arithmetic, ever since. Contents were not her folder. Not yet.
