...
COMPANION.Matter = (function () {
  ...
  var THE_ESSAY = [
    ...
    '',
    'The Scout gives coordinates.',
    'The Coach confirms the pattern.',
    'The Insider speaks as this specific role one final time.',
    '',
  ...
  var PERSONA_PROFILES = [
    ...
    '',
    '## The Scout — The One Who Maps the Territory',
    ...
    '',
    '## The Coach — The Pattern of the Seeker\'s Own Work, Made Conscious',
    ...
    '',
    '## The Insider — The Jobs Themselves, Given Voice',
    ...
    '',
    '## The Mirror — The Role That Looks Right But Isn\'t',
